...
class GroupService {
  ...
  Future<Group> createGroup(String name, List<Peer> members, {bool showHistoryToNew = false}) async {
    ...
    await _db.insertGroupMember(GroupMembersCompanion.insert(
      groupId: groupId,
      peerId: _myPeerId,
  ...
  Future<void> _broadcastToGroup(String groupId, Map<String, dynamic> payload, {String? excludePeerId}) async {
